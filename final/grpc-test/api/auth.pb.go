...
func (x *UserIdAndToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserIdAndToken) ProtoMessage() {}

func (x *UserIdAndToken) ProtoReflect() protoreflect.Message {
	mi := &file_api_auth_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserIdAndToken.ProtoReflect.Descriptor instead.
func (*UserIdAndToken) Descriptor() ([]byte, []int) {
	return file_api_auth_proto_rawDescGZIP(), []int{2}
}

func (x *UserIdAndToken) GetUserId() *UserId {
	if x != nil {
		return x.UserId
	}
	return nil
...
func (x *UserIdAndToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_api_auth_proto_rawDesc = []byte{
	...
	,
...
var file_api_auth_proto_goTypes = []interface{}{
	(*UserId)(nil),         // 0: UserId
	(*UserToken)(nil),      // 1: UserToken
	(*UserIdAndToken)(nil), // 2: UserIdAndToken
	(*emptypb.Empty)(nil),  // 3: google.protobuf.Empty
}
var file_api_auth_proto_depIdxs = []int32{
	0, // 0: UserIdAndToken.user_id:type_name -> UserId
	2, // 1: Auth.SetUserToken:input_type -> UserIdAndToken
	0, // 2: Auth.GetUserToken:input_type -> UserId
	3, // 3: Auth.SetUserToken:output_type -> google.protobuf.Empty
	2, // 4: Auth.GetUserToken:output_type -> UserIdAndToken
